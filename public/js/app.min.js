...
function initBePaidPayment(orderData) {
    ...
    const paymentParams = {
        ...
        checkout: {
            ...
            shop: {
                id: "33460", // ← строка, но совпадает с shop_id
                name: "Cafe 180",
                country: "BY",
            ...
            test: false // ← ✅ главное: теперь реальный режим
        },
...
function openDelivery() {
    ...
    if (orders.length !== 0) {
        ...
        const deliveryFee = totalAmount >= 40 ? 0 : 6;
        ...
        <div class="csform">
          ...
          <div class="cfooter">
            <div class="cfooter__total">
              <div class="cfooter__meta">${deliveryFee === 0 ? 'Доставка бесплатно от 40 руб.' : 'Стоимость доставки — 6 руб.'}</div>
            </div>
            <div class="cfooter__total">
              <div class="cfooter__left">Итого</div>
